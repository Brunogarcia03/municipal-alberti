...
import { formatDate, getReadingTime } from "@/utils/tools";
...
export default async function Page({ params }) {
  ...
  return (
    <main className="flex flex-col items-center justify-center w-full h-full overflow-hidden bg-white text-black white-container -mt-10">
      <section className="pt-[calc(10rem)] md:pt-[calc(13rem)] w-[90vw] sm:w-[95vw] md:max-w-[1560px] mx-auto">
        <div className="flex flex-col items-start">
          ...
          <h1 className="font-light leading-[1.15] relative w-full md:w-[80vw] mb-4">
            <span className="md:block w-full text-2xl md:text-4xl lg:text-5xl italic uppercase text-blue">
              {news[0].titulo}
            </span>
          </h1>
        ...
        <div className="w-full h-[1px] bg-gray rounded-md my-[1rem]" />
      ...
      <section className="w-[90vw] sm:w-[95vw] md:max-w-[1560px] mx-auto">
        <div className="w-full h-[1px] bg-gray rounded-md my-[1.5rem]" />
